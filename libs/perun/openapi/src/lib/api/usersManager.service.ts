...
export class UsersManagerService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public changeNonAuthzPassword(i: string, m: string, password: string, lang?: string, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public changeNonAuthzPassword(i: string, m: string, password: string, lang?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public changeNonAuthzPassword(i: string, m: string, password: string, lang?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public changeNonAuthzPassword(i: string, m: string, password: string, lang?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public checkPasswordResetRequestIsValid(i: string, m: string, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public checkPasswordResetRequestIsValid(i: string, m: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public checkPasswordResetRequestIsValid(i: string, m: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public checkPasswordResetRequestIsValid(i: string, m: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (i === null || i === undefined) {
