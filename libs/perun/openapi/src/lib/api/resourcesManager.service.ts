...
import { EnrichedResource } from '../model/models';
...
export class ResourcesManagerService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getEnrichedResourceById(id: number, attrNames?: Array<string>, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<EnrichedResource>;
    public getEnrichedResourceById(id: number, attrNames?: Array<string>, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpResponse<EnrichedResource>>;
    public getEnrichedResourceById(id: number, attrNames?: Array<string>, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpEvent<EnrichedResource>>;
    public getEnrichedResourceById(id: number, attrNames?: Array<string>, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json'}): Observable<any> {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getEnrichedResourcesForFacility(facility: number, attrNames?: Array<string>, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<Array<EnrichedResource>>;
    public getEnrichedResourcesForFacility(facility: number, attrNames?: Array<string>, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpResponse<Array<EnrichedResource>>>;
    public getEnrichedResourcesForFacility(facility: number, attrNames?: Array<string>, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpEvent<Array<EnrichedResource>>>;
    public getEnrichedResourcesForFacility(facility: number, attrNames?: Array<string>, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json'}): Observable<any> {
        if (facility === null || facility === undefined) {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getEnrichedResourcesForVo(vo: number, attrNames?: Array<string>, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<Array<EnrichedResource>>;
    public getEnrichedResourcesForVo(vo: number, attrNames?: Array<string>, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpResponse<Array<EnrichedResource>>>;
    public getEnrichedResourcesForVo(vo: number, attrNames?: Array<string>, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpEvent<Array<EnrichedResource>>>;
    public getEnrichedResourcesForVo(vo: number, attrNames?: Array<string>, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json'}): Observable<any> {
        if (vo === null || vo === undefined) {
